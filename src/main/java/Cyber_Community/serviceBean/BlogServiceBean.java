...
import Cyber_Community.services.BlogService;
...
public class BlogServiceBean implements BlogService {
   ...
   /*@PostConstruct
    public void init() {
        User user=new User("AnyOne");
        User defaultUser=new User("4n0nymou5","An0nymou5@cyber.es","******","----", Role.USER);
        Club club=new Club("Test club24 ","a",user,"Contact");
        Blog test1 = new Blog("Blog test 1", "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim.\n" +
                        "\n " +
                ...
                "Resume", new User("User1","An0nymou5@cyber.eu","******","----",Role.USER));
        Blog test2 = new Blog("Blog test 2","Content", "Resume",defaultUser);
        Blog test3 = new Blog("Blog test 3","Content", "Resume",defaultUser);
    ...
    @Override
    public Blog create(Long id,Blog blog) {
        this.clubRepository.getById(id).addBlog(blog);
        return this.blogRepository.save(blog);
    }

    @Override
    public Blog update(Blog blog,Long id) {
        Blog blog1=this.blogRepository.getById(id);
    ...
    public List<Blog> byTitle(String t){
        return this.blogRepository.findByTitleContaining(t);
    }
/*
    public List<Blog> byDate(Date d){
        return this.blogRepository.findByDate(d);
    }
 */
